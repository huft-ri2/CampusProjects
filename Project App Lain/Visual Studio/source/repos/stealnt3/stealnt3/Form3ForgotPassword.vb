...
Public Class ForgotPasswordForm
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        If String.IsNullOrWhiteSpace(txtEmail.Text) OrElse
            String.IsNullOrWhiteSpace(txtNewPassword.Text) Then
            lblError.Text = "Semua field wajib diisi."
            Return
        End If

        ' Validasi format password
        If Not IsPasswordValid(txtNewPassword.Text) Then
                ...
                Using reader As MySqlDataReader = cmd.ExecuteReader()
                    If reader.HasRows Then
                        ...
                        If otpPopup.ShowDialog() = DialogResult.OK Then
                            MessageBox.Show("Verifikasi berhasil! Anda akan diarahkan ke LoginForm.",
    ...
    Private Sub btnShowPassword_Click(sender As Object, e As EventArgs) Handles btnShowPassword.Click
        If txtNewPassword.PasswordChar = "*" Then
            txtNewPassword.PasswordChar = ""   ' Tampilkan password
            btnShowPassword.Text = "❌"      ' Ubah teks button jadi 'Hide'
        Else
            txtNewPassword.PasswordChar = "*"  ' Sembunyikan password
